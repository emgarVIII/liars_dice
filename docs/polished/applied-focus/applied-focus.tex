...
\section*{\texorpdfstring{\textbf{\ul{ABSTRACT}}}{ABSTRACT}}\label{abstract}
\addcontentsline{toc}{section}{\textbf{\ul{ABSTRACT}}}
...
\section*{\texorpdfstring{\textbf{\ul{INTRODUCTION}}}{INTRODUCTION}}\label{introduction}
\addcontentsline{toc}{section}{\textbf{\ul{INTRODUCTION}}}
...
\section*{\texorpdfstring{\textbf{\ul{HISTORICAL CONTEXT - DEEPER
DIVE}}}{HISTORICAL CONTEXT - DEEPER DIVE}}\label{historical-context---deeper-dive}
\addcontentsline{toc}{section}{\textbf{\ul{HISTORICAL CONTEXT - DEEPER
DIVE}}}

\section*{\texorpdfstring{\textbf{\ul{ADVANCEMENTS IN GAME SOLVING
MODELS}}}{ADVANCEMENTS IN GAME SOLVING MODELS}}\label{advancements-in-game-solving-models}
\addcontentsline{toc}{section}{\textbf{\ul{ADVANCEMENTS IN GAME SOLVING
MODELS}}}
...
\section*{\texorpdfstring{\textbf{\ul{IMPERFECT INFORMATION
GAMES}}}{IMPERFECT INFORMATION GAMES}}\label{imperfect-information-games}
\addcontentsline{toc}{section}{\textbf{\ul{IMPERFECT INFORMATION
GAMES}}}
...
\section*{\texorpdfstring{\textbf{\ul{MULTI-AGENT
LEARNING}}}{MULTI-AGENT LEARNING}}\label{multi-agent-learning}
\addcontentsline{toc}{section}{\textbf{\ul{MULTI-AGENT LEARNING}}}

Look into older/other multi-agent learning examples \& research areas,
can write history about this (milestones)

\section*{\texorpdfstring{\textbf{\ul{BROADER
IMPLICATIONS}}}{BROADER IMPLICATIONS}}\label{broader-implications}
\addcontentsline{toc}{section}{\textbf{\ul{BROADER IMPLICATIONS}}}
...
\section*{\texorpdfstring{\textbf{\ul{ABOUT TEXAS
HOLD\textquotesingle EM
POKER}}}{ABOUT TEXAS HOLD\textquotesingle EM POKER}}\label{about-texas-holdem-poker}
\addcontentsline{toc}{section}{\textbf{\ul{ABOUT TEXAS
HOLD\textquotesingle EM POKER}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{WHY IT IS A USEFUL IMPERFECT
INFORMATION
GAME:}}}{WHY IT IS A USEFUL IMPERFECT INFORMATION GAME:}}\label{why-it-is-a-useful-imperfect-information-game}
\addcontentsline{toc}{subsection}{\textbf{\ul{WHY IT IS A USEFUL
...
\section*{\texorpdfstring{\textbf{\ul{KEY FOUNDATIONAL CONCEPTS USED TO
BUILD LIBRATUS \&
PLURIBUS:}}}{KEY FOUNDATIONAL CONCEPTS USED TO BUILD LIBRATUS \& PLURIBUS:}}\label{key-foundational-concepts-used-to-build-libratus-pluribus}
\addcontentsline{toc}{section}{\textbf{\ul{KEY FOUNDATIONAL CONCEPTS
USED TO BUILD LIBRATUS \& PLURIBUS:}}}

\subsection*{\texorpdfstring{\textbf{\ul{EQUILBRIUM
CONCEPTS:}}}{EQUILBRIUM CONCEPTS:}}\label{equilbrium-concepts}
\addcontentsline{toc}{subsection}{\textbf{\ul{EQUILBRIUM CONCEPTS:}}}

\subsection*{\texorpdfstring{\textbf{\ul{NASH
EQUILIBRIUM:}}}{NASH EQUILIBRIUM:}}\label{nash-equilibrium}
\addcontentsline{toc}{subsection}{\textbf{\ul{NASH EQUILIBRIUM:}}}

\subsection*{\texorpdfstring{\textbf{\ul{Definition:}}
}{Definition: }}\label{definition}
\addcontentsline{toc}{subsection}{\textbf{\ul{Definition:}} }
...
\subsection*{\texorpdfstring{\textbf{\ul{Application in
AI:}}}{Application in AI:}}\label{application-in-ai}
\addcontentsline{toc}{subsection}{\textbf{\ul{Application in AI:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{VON NEUMANN'S MINIMAX
THEOREM:}}}{VON NEUMANN'S MINIMAX THEOREM:}}\label{von-neumanns-minimax-theorem}
\addcontentsline{toc}{subsection}{\textbf{\ul{VON NEUMANN'S MINIMAX
THEOREM:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{Why it is relevant, although
not explicitly mentioned in the main research
papers:}}}{Why it is relevant, although not explicitly mentioned in the main research papers:}}\label{why-it-is-relevant-although-not-explicitly-mentioned-in-the-main-research-papers}
\addcontentsline{toc}{subsection}{\textbf{\ul{Why it is relevant,
although not explicitly mentioned in the main research papers:}}}
...
\section*{\texorpdfstring{\textbf{\ul{COUNTERFACTUAL REGRET MINIMIZATION
(CFR):}}}{COUNTERFACTUAL REGRET MINIMIZATION (CFR):}}\label{counterfactual-regret-minimization-cfr}
\addcontentsline{toc}{section}{\textbf{\ul{COUNTERFACTUAL REGRET
MINIMIZATION (CFR):}}}
...
\addcontentsline{toc}{subsection}{\textbf{\ul{HOW IT WORKS:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{Step by
step:}}}{Step by step:}}\label{step-by-step}
\addcontentsline{toc}{subsection}{\textbf{\ul{Step by step:}}}

\subsection{Initialize:}\label{initialize}

\begin{enumerate}
\def\labelenumi{\alph{enumi}.}
\item
  Start with a uniform random strategy for each player at every decision
  point.
\end{enumerate}

\subsection{Traverse the game tree:}\label{traverse-the-game-tree}
...
\subsection{Calculate regrets:}\label{calculate-regrets}

\begin{enumerate}
\def\labelenumi{\alph{enumi}.}
\setcounter{enumi}{2}
\item
  At each decision point, calculate the "regret" for each action, which
  represents the difference in expected utility if that action had been
  chosen instead of the one that was chosen.
\end{enumerate}

\subsection{Update strategy:}\label{update-strategy}
...
\setcounter{enumi}{4}
\item
  Continue iterating through the game tree, updating strategies based on
  calculated regrets until convergence is reached (regrets become
  negligible).
\end{enumerate}

\section*{\texorpdfstring{\textbf{\ul{LIBRATUS:}}}{LIBRATUS:}}\label{libratus}
\addcontentsline{toc}{section}{\textbf{\ul{LIBRATUS:}}}

\subsection*{\texorpdfstring{\textbf{\ul{SUMMARY:}}}{SUMMARY:}}\label{summary}
\addcontentsline{toc}{subsection}{\textbf{\ul{SUMMARY:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{HOW IT WORKS (HIGH
LEVEL):}}}{HOW IT WORKS (HIGH LEVEL):}}\label{how-it-works-high-level}
\addcontentsline{toc}{subsection}{\textbf{\ul{HOW IT WORKS (HIGH
LEVEL):}}}
...
\subsection{Abstraction (and Blueprint
Strategy):}\label{abstraction-and-blueprint-strategy}
...
\item
  ...
  is not so different to \$101). This process reduces the complexity of
  the game while preserving its essential strategic elements.
\item
  ...
  For the later stages, this blueprint provides a general framework that
  can be refined as the game progresses.
\end{itemize}

\subsection{Nested Subgame Solving:}\label{nested-subgame-solving}

\begin{itemize}
\item
  When a later part of the game is reached, Libratus constructs a
  finer-grained abstraction for that subgame and solves it in real time.
  This nested subgame solving ensures that the solution fits within the
  larger blueprint strategy, providing a provable safety guarantee.
\end{itemize}

\subsection{\texorpdfstring{Self-Improving Algorithm:
}{Self-Improving Algorithm: }}\label{self-improving-algorithm}
...
\subsection*{\texorpdfstring{\textbf{\ul{HOW IT OVERCOMES THE IMPERFECT
INFORMATION
OBSTACLE:}}}{HOW IT OVERCOMES THE IMPERFECT INFORMATION OBSTACLE:}}\label{how-it-overcomes-the-imperfect-information-obstacle}
\addcontentsline{toc}{subsection}{\textbf{\ul{HOW IT OVERCOMES THE
IMPERFECT INFORMATION OBSTACLE:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{RELATION TO MULTI-AGENT
LEARNING:}}}{RELATION TO MULTI-AGENT LEARNING:}}\label{relation-to-multi-agent-learning}
\addcontentsline{toc}{subsection}{\textbf{\ul{RELATION TO MULTI-AGENT
LEARNING:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{LIMITATIONS:}}}{LIMITATIONS:}}\label{limitations}
\addcontentsline{toc}{subsection}{\textbf{\ul{LIMITATIONS:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{STRENGTHS:}}}{STRENGTHS:}}\label{strengths}
\addcontentsline{toc}{subsection}{\textbf{\ul{STRENGTHS:}}}
...
\section*{\texorpdfstring{\textbf{\ul{FUTURE WORK
DIRECTIONS:}}}{FUTURE WORK DIRECTIONS:}}\label{future-work-directions}
\addcontentsline{toc}{section}{\textbf{\ul{FUTURE WORK DIRECTIONS:}}}

\section*{\texorpdfstring{\textbf{\ul{PLURIBUS:}}}{PLURIBUS:}}\label{pluribus}
\addcontentsline{toc}{section}{\textbf{\ul{PLURIBUS:}}}

\subsection*{\texorpdfstring{\textbf{\ul{SUMMARY:}}}{SUMMARY:}}\label{summary-1}
\addcontentsline{toc}{subsection}{\textbf{\ul{SUMMARY:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{HOW IT WORKS (HIGH
LEVEL):}}}{HOW IT WORKS (HIGH LEVEL):}}\label{how-it-works-high-level-1}
\addcontentsline{toc}{subsection}{\textbf{\ul{HOW IT WORKS (HIGH
LEVEL):}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{HOW IT OVERCOMES THE IMPERFECT
INFORMATION
OBSTACLE:}}}{HOW IT OVERCOMES THE IMPERFECT INFORMATION OBSTACLE:}}\label{how-it-overcomes-the-imperfect-information-obstacle-1}
\addcontentsline{toc}{subsection}{\textbf{\ul{HOW IT OVERCOMES THE
IMPERFECT INFORMATION OBSTACLE:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{RELATION TO MULTI-AGENT
LEARNING:}}}{RELATION TO MULTI-AGENT LEARNING:}}\label{relation-to-multi-agent-learning-1}
\addcontentsline{toc}{subsection}{\textbf{\ul{RELATION TO MULTI-AGENT
LEARNING:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{LIMITATIONS:}}}{LIMITATIONS:}}\label{limitations-1}
\addcontentsline{toc}{subsection}{\textbf{\ul{LIMITATIONS:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{COST TO
USE:}}}{COST TO USE:}}\label{cost-to-use}
\addcontentsline{toc}{subsection}{\textbf{\ul{COST TO USE:}}}
...
\subsection*{\texorpdfstring{\textbf{\ul{STRENGTHS:}}}{STRENGTHS:}}\label{strengths-1}
\addcontentsline{toc}{subsection}{\textbf{\ul{STRENGTHS:}}}
...
\section*{\texorpdfstring{\textbf{\ul{FUTURE WORK
DIRECTIONS:}}}{FUTURE WORK DIRECTIONS:}}\label{future-work-directions-1}
\addcontentsline{toc}{section}{\textbf{\ul{FUTURE WORK DIRECTIONS:}}}
...
\section*{\texorpdfstring{\textbf{\ul{CONCLUSION}}
}{CONCLUSION }}\label{conclusion}
\addcontentsline{toc}{section}{\textbf{\ul{CONCLUSION}} }
...
\section*{\texorpdfstring{\textbf{\ul{REFERENCES:}}}{REFERENCES:}}\label{references}
\addcontentsline{toc}{section}{\textbf{\ul{REFERENCES:}}}
...
\subsection{More DeepBlue:}\label{more-deepblue}
...
\subsection{\texorpdfstring{Google AlphaGo:
}{Google AlphaGo: }}\label{google-alphago}
...
\subsection{Neumann:}\label{neumann}
