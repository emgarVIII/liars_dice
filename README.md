...
├── docs/polished/             # Polished public paper editions and internal review notes
...
The three university research documents are preserved as original research artifacts. They are the source of truth for the original research structure, math, figures, implementation details, and project trajectory. Polished public editions are generated from the original DOCX files without rewriting the papers.
...
The polished final report and applied focus editions preserve the original text and improve formatting. The research notes edition removes disruptive blank-tab pages and cleans informal placeholders. The website, tests, and exported metrics are the source of truth for the current public version.
