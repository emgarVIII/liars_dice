...
\item
  Study poker AI and CFR-style algorithms.
\item
...
careful. It talks about CFR-style training and best-response
...
The updated public policy is count-aware. Its keys include public dice
counts and private hands. That improved benchmark performance because
the policy could adapt to match state instead of reusing a fixed
